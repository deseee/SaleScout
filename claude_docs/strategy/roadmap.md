...
**Last Updated:** 2026-04-01 (v88 — S367: #228–237 Dashboard Makeover + Settlement Hub spec complete. S366/S367 dashboard bug fixes pushed. All S367 pushes confirmed on GitHub.)
...
| 228 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete S367 — Pending Patrick decisions + Dev dispatch | Settlement Hub (Commission Calc + Expense Tracker + Client Payout) | ORG | SIMPLE | 5 Patrick decisions needed — see dev-brief-S367.md. Estate/consignment/auction: full 5-step wizard. Yard sale: 3-field reconciliation. Schema: SaleSettlement, SaleExpense, ClientPayout. | Full arch + UX spec in claude_docs/feature-notes/. Highest-ROI feature per Investor agent. Stripe Connect payout to homeowner/executor. |
...
| 230 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete S367 — Pending Dev dispatch | Smart Buyer Intelligence Widget | ORG | SIMPLE | Dev dispatch Phase 1 | "Who's Coming" widget: upcoming shoppers by tier (Explorer, Hunter, etc.), top 3 profiles with avatar+rank. Leverages FindA.Sale's unique shopper XP data. API: GET /api/organizers/smart-buyers/:saleId |
| 231 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete S367 — Pending Dev dispatch | High-Value Item Tracker | ORG | SIMPLE | Dev dispatch Phase 1 | Flag items above threshold for special handling. Compact card with photo/name/price, inline Reserve/Mark Sold/Unflag actions. Schema: Item.isHighValue, Item.highValueThreshold. |
| 232 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete S367 — Pending Dev dispatch | Sale Pulse Widget (Engagement Score) | ORG | ALL | Dev dispatch Phase 1 | Real-time engagement: page views, item saves, shopper questions, buzz score 0-100. "Boost visibility" CTA. Only FindA.Sale has buyer-side data to power this. API: GET /api/organizers/sale-pulse/:saleId |
| 233 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete S367 — Pending Dev dispatch | Organizer Efficiency Coaching Widget | ORG | ALL | Dev dispatch Phase 1 | Feature-gated (not tier-gated): shows coaching relevant to features the organizer is actively using. No subscription gate. Private benchmarks: avg photo-to-publish time, sell-through rate, percentile vs. peer cohort. Coaching framing, not judgment. API: GET /api/organizers/efficiency-stats |
| 234 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete S367 — Pending Dev dispatch | Post-Sale Momentum Prompt | ORG | ALL | Dev dispatch Phase 1 | Appears 0-48h after sale closes (State 3). Summary stats from completed sale + "Start Next Sale" pre-filling create-sale form with previous sale data. |
...
| 236 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete S367 — Pending Dev dispatch | Weather Strip Widget | ORG | ALL | Dev dispatch Phase 1 | Thin forecast bar near sale title. Shows only if sale date ≤ 10 days out. Weather API integration needed (suggest OpenWeatherMap or similar). |
| 237 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | Spec Complete S367 — Pending Dev dispatch | Sale-Type Adaptive Dashboard (Command Center) | ORG | ALL | Dev dispatch Phase 1 | dashboard-sale-type-config.ts lookup object drives per-sale-type widget visibility, CTA, greeting, and settlement type. Estate/consignment/auction get full lifecycle. Yard sale simplified. Flea market deferred to #239. |
