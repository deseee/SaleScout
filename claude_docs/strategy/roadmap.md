...
**Last Updated:** 2026-03-15 (v35 — Session 174 final: #66 Open Data Export shipped, SaleReminder schema added, build fixes applied)
...
| ~~66~~ | ~~Open Data Export~~ | ✅ Done | One-click full data export: items.csv, sales.csv, purchases.csv. ZIP backend job streaming response on GET /api/organizer/export. Dashboard button added. Shipped S174. Trust signal + CCPA/GDPR compliance. |
