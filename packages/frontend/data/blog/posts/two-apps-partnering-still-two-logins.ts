...
export const postZ: BlogPost = {
  slug: 'two-apps-partnering-still-two-logins',
  title: 'When Two Apps "Partner Up," You Still Have Two Logins',
  metaDescription: "A cataloging tool and a listing directory just announced a partnership. Here's why bundling two apps isn't the same as one real platform.",
  publishDate: '2026-10-08',
  category: 'guides',
  readingTimeMinutes: 5,
  excerpt: 'Two point tools announcing a partnership can look like an all-in-one platform from the outside. From the inside, it\'s still two logins, two support teams, and two places your data can get out of sync.',
  body: `## Two companies teaming up isn't the same as one platform
