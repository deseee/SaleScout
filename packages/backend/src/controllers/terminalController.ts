...
// CashSaleError, CashSaleResult, processCashSaleCore, and the cashPayment route handler
// (POST /api/stripe/terminal/cash-payment, also serves the frontend's Venmo/Zelle POS
// buttons) moved to ./cashPaymentController.ts (2026-09-09 Square-changeover extraction --
// pure move, no logic change, cash never touched Stripe). Import them from there.
